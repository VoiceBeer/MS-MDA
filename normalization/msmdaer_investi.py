...
LastEditTime: 2021-03-10 07:46:38
'''
# standard
import argparse
import torch
    ...
    def train(self):
        ...
        for i in range(1, self.iteration+1):
            ...
            for j in range(len(source_iters)):
                ...
                # gamma   = 1
                loss = cls_loss + gamma * mmd_loss + beta/1000 * l1_loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--norm_type', type=str, default='ele', help='the normalization type used for data')
