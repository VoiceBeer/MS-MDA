# MS-MDA [![PWC](https://img.shields.io/endpoint.svg?url=https://paperswithcode.com/badge/ms-mda-multisource-marginal-distribution/eeg-on-seed-1)](https://paperswithcode.com/sota/eeg-on-seed-1?p=ms-mda-multisource-marginal-distribution)
